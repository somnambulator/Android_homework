...
public class MainActivity extends AppCompatActivity {
    ...
    private void showMsgs(List<Message> msgList) {
    ...
    private void getData(String studentId){
        new Thread(new Runnable() {
            @Override
            public void run() {
                List<Message> msgs = baseGetMsgsFromRemote(studentId);
                //  Log.d(TAG,studentId);
    ...
    public List<Message> baseGetMsgsFromRemote(String studentId) {
        String urlStr =
        ...
        try {
            ...
            if (conn.getResponseCode() == 200) {
                ...
                MessageListResponse msg;
                msg = new Gson().fromJson(reader, new TypeToken<MessageListResponse>() {
                }.getType());
                result = msg.feeds;
